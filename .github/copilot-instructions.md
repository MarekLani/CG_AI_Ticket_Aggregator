...
The vendor-neutral source of agent rules is `AGENTS.md`.

Before planning, implementing, or reviewing:

- read `AGENTS.md`;
- read `docs/product/solution-overview.md`;
- read the relevant standards and architecture documentation referenced by `AGENTS.md`;
