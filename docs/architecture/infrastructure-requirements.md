...
- Identity: support Microsoft Entra ID integration and managed identity for Azure workloads where required; exact identity resources and RBAC remain infrastructure-owned.
